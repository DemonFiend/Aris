...
export class CustomAnthropicProvider implements AIProvider {
  readonly id = 'custom-anthropic';
  readonly name = 'Custom Anthropic-compatible';
  ...
  constructor(baseUrl: string, apiKey?: string, defaultModel = 'claude-sonnet-4-20250514') {
  ...
  async getModels(): Promise<ModelInfo[]> {
    return [
      { id: this.defaultModel, name: this.defaultModel, supportsVision: true, contextLength: 200000 },
    ];
  }
